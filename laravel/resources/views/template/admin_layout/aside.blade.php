                ...
                <div class="flex scrollable hover">
                    <div class="nav-active-text-primary" data-nav>
                        <ul class="nav bg">
                            ...
                            <li>
                                <a href="{{ url('') }}/admin/data/pendataan/pendataan">
                                    <span class="nav-icon text-warning"><i data-feather='users'></i></span>
                                    <span class="nav-text">Pendataan</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('') }}/admin/data/users/users">
